...
public class StudentMethod {
    ...
    public Student inItMethod(String studentId) {
        ...
        Student student = new Student(studentId, studentName); // 수강생 인스턴스 생성
    ...
    //필수과목 메서드
     public void mandatoryMethod(List<Subject> subjectStore) {
        //필수과목 리시트 보여주기
        System.out.println("========================================================================");
        ...
        //필수과목 입력받기
        loop:
        for (int i = 1; i < subjectStore.size(); i++) {
   ...
   public void choiceMethod(List<Subject> subjectStore) {
        //필수과목 리시트 보여주기
        System.out.println("========================================================================");
        for (Subject subject : subjectStore) {
            SubjectList s = subject.getSubjectList();
